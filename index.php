...
<div class="tab-pane fade" id="local" role="tabpanel" >
  <div class="col-md-4 text-right">
    <?php query_posts('category_name=local&posts_per_page=7' ); ?>
    <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); $do_not_duplicate[] = $post->ID; ?>
      <div class="article-link">
        <a href="<?php the_permalink(); ?>"><h4><?php the_title(); ?></h4></a>
        <p class="article-desc"><?php echo get_the_excerpt(); ?></p>
...
<div class="tab-pane fade" id="national" role="tabpanel" >
  <div class="col-md-4 text-right">
    <?php query_posts('category_name=national&posts_per_page=7' ); ?>
    <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); $do_not_duplicate[] = $post->ID; ?>
      <div class="article-link">
        <a href="<?php the_permalink(); ?>"><h4><?php the_title(); ?></h4></a>
        <p class="article-desc"><?php echo get_the_excerpt(); ?></p>
...
<div class="tab-pane fade" id="international" role="tabpanel">
  <div class="col-md-4 text-right">
    <?php query_posts('category_name=world&posts_per_page=7' ); ?>
    <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); $do_not_duplicate[] = $post->ID; ?>
      <div class="article-link">
        <a href="<?php the_permalink(); ?>"><h4><?php the_title(); ?></h4></a>
        <p class="article-desc"><?php echo get_the_excerpt(); ?></p>
